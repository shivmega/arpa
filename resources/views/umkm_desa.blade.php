...
<head>
    <meta charset="UTF-8" />
    <title>UMKM DESA {{ Auth::user()->desa }}</title>
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden lg:px-4">
                <div
                    ...
                    <div class="w-full md:w-1/2 flex">
                        <button type="button" onclick="window.location.href='{{ route('export.pdf.umkm.desa') }}'"
                            ...
                            Unduh UMKM {{$desas->find(Auth::user()->desa)->nama_desa}} .pdf
                        </button>
                        <button type="button" onclick="window.location.href='{{ route('export.excel.umkm.desa') }}'"
                            ...
                            Unduh UMKM {{$desas->find(Auth::user()->desa)->nama_desa}} .xlsx
                        </button>
                    </div>
                    <div
                        class="w-full md:w-auto flex flex-col lg:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                        ...
                        <button type="button" onclick="window.location.href='{{ route('umkm') }}'"
                            ...
                            @foreach ($umkms as $umkm)
                                <tr
                                    ...
                                    <td class="px-4 py-3 items-end">
                                        ...
                                        <form action="{{ route('delete.umkm', ['umkm' => $umkm]) }}" method="post">
                                            @csrf
                                            @method('delete')
