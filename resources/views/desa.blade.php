                ...
                <div
                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center" method="GET">
                            ...
                            <label for="keyword" class="sr-only">Pencarian</label>
                            <div class="relative w-full">
                                ...
                                <input type="text" id="keyword" name="keyword"
                                    ...
                                    placeholder="Cari dengan Nama Desa, Nama Kades, atau Kecamatan">
                            </div>
                        </form>
                    </div>
                    ...
                    <div
                        ...
                        <button type="button" onclick="window.location.href='{{ route('halaman.tambah.desa') }}'"
                ...
                <div class="overflow-x-auto">
                    @if (Auth::user()->role!=="desa")
                       <div class="inline-flex mx-3 ">
                        <div
                            class="md:w-auto inline-flex md:flex-row space-y-2 md:space-y-0 md:items-center md:mb-4 md:space-x-3 flex-shrink-0">
                            <button type="button" onclick="window.location.href='{{ route('export.pdf.desa') }}'"
                        ...
                        <div
                            class=" w-full md:w-auto md:flex-row inline-flex space-y-2 md:space-y-0 md:items-center md:mx-3 md:mb-4 md:space-x-3 flex-shrink-0">
                            <button type="button" onclick="window.location.href='{{ route('export.excel.desa') }}'"
                    ...
                    <table class="w-full text-sm rounded-sm text-left text-gray-500 dark:text-gray-400 even:bg-gray-50">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-100 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Kepala Desa</th>
                            ...
                            @foreach ($desas as $desa)
                                <tr
                                    ...
                                    <th scope="row"
                                        ...
                                        {{ $desa->nama_desa }}</th>
                                    <td class="px-4 py-3">{{ $desa->nama_kades }}</td>
                                    <td class="px-4 py-3">{{ $desa->kecamatan }}</td>
                                    <td class="px-4 py-3 flex">
                                        <button type="button"
                                            onclick="window.location.href='{{ route('desa.details', ['desa' => $desa]) }}'"
                                        ...
                                        @if (Auth::user()->role == 'admin' || Auth::user()->role == 'super_admin')
                                            <button data-modal-target="popup-modal {{ $desa }}"
                                                data-modal-toggle="popup-modal {{ $desa }}"
                                                ...
                                                <div class="relative p-4 w-full max-w-md max-h-full">
                                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                        ...
                                                        <div class="p-4 md:p-5 text-center">
                                                            ...
                                                            <form
                                                                action="{{ route('delete.desa', ['desa' => $desa]) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('delete')
                                                            ...
                                                            <button data-modal-hide="popup-modal {{ $desa }}"
                                                                type="button"
