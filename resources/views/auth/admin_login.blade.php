...
<body>
    ...
    <div class="flex flex-col items-center justify-center px-6 pt-8 mx-auto md:h-screen pt:mt-0 "
        style="background-image: url('{{ asset('images/museum_kaliasa.jpeg') }}')">
        <!-- Card -->
        <div class="w-full max-w-xl p-6 space-y-8 sm:p-8 backdrop-blur-xl bg-white/50 rounded-lg shadow ">
            ...
            <form class="mt-8 space-y-6" action="login" method="POST" role="form">
                ...
                <div class="flex items-end">
                    <a href="{{ route('admin.registrasi') }}"class="text-blue-700 hover:underline"> Buat Akun Admin Baru</a>
                    <a href="{{ route('lupa_password') }}" class="ml-auto  text-blue-700 hover:underline ">Lupa Password
                        Admin?</a>
                </div>
            </form>
