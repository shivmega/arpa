...
<head>
    <meta charset="UTF-8" />
    <title>Edit Desa {{$desa->nama_desa}}</title>
...
<body class="dark:bg-gray-900 bg-gray-200">
    ...
    <main class="p-4 md:ml-64 h-auto pt-20 ">
        <div class=" rounded-lg dark:bg-gray-800 bg-white border-gray-300 dark:border-gray-600 h-auto mb-4 px-3 py-4">
            ...
            <form action="{{ route('edit.desa', ['desa'=>$desa]) }}" method="POST" role="form">
                @csrf
                <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="nama_desa" id="nama_desa"
                            ...
                            value="{{$desa->nama_desa}}" placeholder="contoh: Rejasa" required>
                    </div>
                    <div class="w-full">
                        ...
                        <input type="text" name="nama_kades" id="nama_kades"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            value="{{$desa->nama_kades}}" placeholder="contoh: Lukman Indrajaya" required>
                    </div>
                    <div class="w-full">
                        ...
                        <input type="text" name="nama_sekdes" id="nama_sekdes"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            value="{{$desa->nama_sekdes}}" placeholder="">
                    </div>
                    <div class="w-full">
                        ...
                        <input type="text" name="nama_perangkat_desa" id="nama_perangkat_desa"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            value="{{$desa->nama_perangkat_desa}}">
                    </div>
                    <div class="w-full">
                        ...
                        <input type="text" name="kecamatan" id="kecamatan"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            value="{{$desa->kecamatan}}" placeholder="">
                    </div>
                    <div class="w-full">
                        ...
                        <input type="text" name="kabupaten" id="kabupaten"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            value="{{$desa->kabupaten}}" placeholder="">
                    </div>
                    <div class="w-full">
