                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                    ...
                    <div class="w-full flex">
                        <div class="w-1/2">
                            ...
                            <input type="text" name="produk" id="produk"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                value="{{ $umkm->produk }}" placeholder="contoh: Keripik Pisang" disabled>
                        </div>
                        <div class="w-1/2 ml-5">
                            ...
                            <input type="text" name="pemilik_umkm" id="pemilik_umkm"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                value="{{ $umkm->pemilik_umkm }}" placeholder="Ibu Marsinah" disabled >
                        </div>
                    </div>
                    <div class="w-full">
                        ...
                        <div class="w-1/2">
                            ...
                            <select id="desa" name="desa" 
                                ...
                                @foreach ($desas as $desa)
                                    <option disabled
                                        value="{{ $desa->id }} "{{ $umkm->desa == $desa->id ? 'selected' : '' }}>
                        ...
                        <div class="w-1/2 inline ml-5">
                            ...
                            <select id="tahun_berdiri" name="tahun_berdiri" disabled
                                ...
                                @for ($tahun = 2024; $tahun >= 1980; $tahun--)
                                    <option value="{{ $tahun }}"
                                        {{ $umkm->tahun_berdiri == $tahun ? 'selected' : '' }}>
                                        {{ $tahun }}
                                    </option>
                                @endfor
                            </select>
                    ...
                    <div class="w-full flex">
                        <div class="w-1/2">
                            ...
                            <input type="text" name="jangkauan_pasar" id="jangkauan_pasar" disabled
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                value="{{ $umkm->jangkauan_pasar }}">
                        </div>
                        <div class="w-1/2 inline ml-5">
                            <label for="omset" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Omset</label>
                            <input type="number" name="omset" id="omset" disabled
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                value="{{ $umkm->omset }}">
                        </div>
                    </div>
                    ...
                    <div class="w-full">
                        ...
                        <div class="w-full mt-5">
                            <label for="keterangan"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Keterangan</label>
                            <input type="text" name="keterangan" id="keterangan" disabled
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                value="{{ $umkm->keterangan }}">
                        </div>
                    </div>
                        ...
                        <div class="flex">
                            <div class="w-1/3">
                                <div class="w-full items-center mt-2">
                                    <input id="online1" type="checkbox" value="Whatsapp" name="pasar_online[]" disabled
                                        @if (collect($pasar_online)->contains('Whatsapp')) checked @endif
                                ...
                                <div class="w-full items-center mt-2">
                                    <input id="online2" type="checkbox" value="Shopee" name="pasar_online[]" disabled
                                        @if (collect($pasar_online)->contains('Shopee')) checked @endif
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="online2"
                                ...
                                <div class="w-full items-center mt-2">
                                    <input id="online3" type="checkbox" value="TikTok" name="pasar_online[]" disabled
                                        @if (collect($pasar_online)->contains('TikTok')) checked @endif
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="online3"
                                ...
                                <div class="w-full items-center mt-2">
                                    <input id="online4" type="checkbox" value="Tokopedia" name="pasar_online[]" disabled
                                        @if (collect($pasar_online)->contains('Tokopedia')) checked @endif
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="online4"
                                ...
                                <div class="w-full items-center mt-2">
                                    <input id="online5" type="checkbox" value="Amazon" name="pasar_online[]" disabled
                                        @if (collect($pasar_online)->contains('Amazon')) checked @endif
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="online5"
                            ...
                            <div class="w-1/3 inline">
                                <div class="w-full items-center mt-2">
                                    <input id="online6" type="checkbox" value="Whatsapp_business" disabled
                                        name="pasar_online[]" @if (collect($pasar_online)->contains('Whatsapp_business')) checked @endif
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="online6"
                                        class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Whatsapp
                                        Business
                                ...
                                <div class="w-full items-center mt-2">
                                    <input id="online7" type="checkbox" value="Website" name="pasar_online[]" disabled
                                        @if (collect($pasar_online)->contains('Website')) checked @endif
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="online7"
                                ...
                                <div class="w-full items-center mt-2">
                                    <input id="online8" type="checkbox" value="Youtube" name="pasar_online[]" disabled
                                        @if (collect($pasar_online)->contains('Youtube')) checked @endif
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="online8"
                                ...
                                <div class="w-full items-center mt-2">
                                    <input id="online9" type="checkbox" value="E-Katalog" name="pasar_online[]" disabled
                                        @if (collect($pasar_online)->contains('E-Katalog')) checked @endif
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="online9"
                                ...
                                <div class="w-full items-center mt-2">
                                    <input id="online10" type="checkbox" value="Google Ads" name="pasar_online[]" disabled
                                        @if (collect($pasar_online)->contains('Google Ads')) checked @endif
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="online10"
                            ...
                            <div class="w-1/3 inline">
                                <div class="w-full items-center mt-2">
                                    <input id="online11" type="checkbox" value="Instagram" name="pasar_online[]" disabled
                                        @if (collect($pasar_online)->contains('Instagram')) checked @endif
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="online11"
                                ...
                                <div class="w-full items-center mt-2">
                                    <input id="online12" type="checkbox" value="Facebook" name="pasar_online[]" disabled
                                        @if (collect($pasar_online)->contains('Facebook')) checked @endif
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="online12"
                                ...
                                <div class="w-full items-center mt-2">
                                    <input id="online13" type="checkbox" value="SMS_Telepon" disabled
                                        name="pasar_online[]
                                    @if (collect($pasar_online)->contains('SMS_Telepon')) checked @endif"
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="online13"
                                ...
                                <div class="w-full items-center mt-2">
                                    <input id="online14" type="checkbox" value="Marketplace" name="pasar_online[]" disabled
                                        @if (collect($pasar_online)->contains('Marketplace')) checked @endif
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="online14"
