...
<body class="dark:bg-gray-900 bg-gray-200">
    ...
    <main class="p-4 md:ml-64 h-auto pt-20 ">
        <div class=" rounded-lg dark:bg-gray-800 bg-white border-gray-300 dark:border-gray-600 h-auto mb-4 px-3 py-4">
            ...
            <form action="{{ route('tambah.laporan') }}" method="POST" role="form">
                @csrf
                <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                    <div class="sm:col-span-2">
                        ...
                        <select id="nama" name="nama"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-m rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <option value="" disabled>UMKM</option>
                            @foreach ($umkms as $umkm)
                                <option value="{{ $umkm->nama_umkm }}">
                                    {{ $umkm->nama_umkm }}
                                </option>
                            @endforeach
                            <option value="" disabled>BUMDESA</option>
                            @foreach ($bumdesas as $bumdesa)
                                <option value="{{ $bumdesa->nama_bumdesa }}">
                        ...
                        <ul
                            ...
                            <li
                                ...
                                <div class="flex items-center ps-3">
                                    <input id="horizontal-list-radio-license" type="radio" value="umkm"
                                        name="institusi" id="institusi"
                            ...
                            <li class="w-full dark:border-gray-600">
                                <div class="flex items-center ps-3">
                                    <input id="horizontal-list-radio-passport" type="radio" value="bumdes"
                                        name="institusi" id="institusi"
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                    ...
                    <div class="w-full">
                        ...
                        <input type="number" name="penyertaan_modal" id="penyertaan_modal"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            value="">
                    </div>
                    <div class="w-full">
                    ...
                    <div class="w-full">
                        ...
                        <input type="number" name="pendapatan_bersih" id="pendapatan_bersih"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            value="" placeholder="">
                    </div>
                    <div class="w-full">
                        ...
                        <input type="number" name="kontribusi_pades" id="kontribusi_pades"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            value="">
                    </div>
